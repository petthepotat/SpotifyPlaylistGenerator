...
playlist = spotifyapi.Playlist("https://open.spotify.com/playlist/0EolJ8nv19zQXm9Va1W0YH?si=a740408c32f14df5")
playlist.add_songs(songs=[seed_song])
rec = spotifyapi.Recommendation(
        limit=30, market="US", seed_tracks=spotifyapi.Recommendation.generate_seed_song_array(songs),
